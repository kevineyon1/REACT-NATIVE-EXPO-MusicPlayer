...
export const play = async (playbackObj, uri, lastPosition) => {
  try {
    ...
    console.log('error ketika play', error.message);
  }
};
...
export const pause = async playbackObj => {
  try {
    ...
    console.log('error ketika pause', error.message);
  }
};
...
export const resume = async playbackObj => {
  try {
    ...
    console.log('error ketika resume', error.message);
  }
};
...
export const playNext = async (playbackObj, uri) => {
  try {
    ...
    console.log('error ketika ganti lagu', error.message);
  }
};
